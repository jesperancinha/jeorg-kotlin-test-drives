...
class XmlBookDomXpathParserManagerTest {
    @Test
    @Throws(Exception::class)
    fun testGetBookTitle() {
        val inputStream = javaClass.getResourceAsStream("testXmlFileForDom.xml")
        inputStream.shouldNotBeNull()
        val pm: XmlBookParserBuilder = XmlBookDomXpathParserManager(inputStream)
        pm.init()
