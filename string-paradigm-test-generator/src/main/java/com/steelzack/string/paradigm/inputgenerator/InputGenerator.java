...
public class InputGenerator {
	...
	void createTestFile(final InputGeneratorOptions options) throws FileNotFoundException, IOException {
	...
	InputStream getStreamFromFileName(final String filename) throws FileNotFoundException {
		return getStreamFromFileName(filename);
	}
