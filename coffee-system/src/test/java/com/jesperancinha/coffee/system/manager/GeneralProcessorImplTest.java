...
import com.jesperancinha.coffee.system.concurrency.CoffeCallable;
import com.jesperancinha.coffee.system.concurrency.CoffeeCallableImpl;
import com.jesperancinha.coffee.system.concurrency.PaymentCallable;
import com.jesperancinha.coffee.system.concurrency.PaymentCallableImpl;
import com.jesperancinha.coffee.system.concurrency.PostActionCallable;
...
public class GeneralProcessorImplTest {
	...
	@InjectMocks
	private GeneralProcessor generalProcessor = GeneralProcessorImpl.builder().nIterations(1).preRowSize(2)
			.postRowSize(2).build();
