...
public class ProgrammerProcessorImplTest {
    ...
    public void testProcessProgrammers_One() throws Exception {
        ...
        Programmer programmer = new ProgrammerImpl(Cappuccino, CASH);
    ...
    public void testProcessProgrammers_Ten() throws Exception {
        ...
        final Programmer programmer1 = new ProgrammerImpl(Cappuccino,
                CASH);
        final Programmer programmer2 = new ProgrammerImpl(Cappuccino,
                Payment.CREDITCARD);
        ...
        final Programmer programmer6 = new ProgrammerImpl(Coffee.LatteMachiatto,
                Payment.CREDITCARD);
        final Programmer programmer7 = new ProgrammerImpl(Cappuccino,
                CASH);
        final Programmer programmer8 = new ProgrammerImpl(Cappuccino,
                Payment.CREDITCARD);
    ...
    public void testProcessProgrammers_TenSameSlowest() throws Exception {
        ...
        final Programmer programmer2 = new ProgrammerImpl(Cappuccino,
                CASH);
        final Programmer programmer3 = new ProgrammerImpl(Cappuccino,
                CASH);
        final Programmer programmer4 = new ProgrammerImpl(Cappuccino,
                CASH);
        final Programmer programmer5 = new ProgrammerImpl(Cappuccino,
                CASH);
        final Programmer programmer6 = new ProgrammerImpl(Cappuccino,
                CASH);
        final Programmer programmer7 = new ProgrammerImpl(Cappuccino,
                CASH);
        final Programmer programmer8 = new ProgrammerImpl(Cappuccino,
                CASH);
        final Programmer programmer9 = new ProgrammerImpl(Cappuccino,
                CASH);
        final Programmer programmer10 = new ProgrammerImpl(Cappuccino,
                CASH);
        programmers.add(programmer1);
        programmers.add(programmer2);
        programmers.add(programmer3);
