...
class OriginalDependencyTreeModel : DefaultTreeModel(null), SegmentTreeModel {
    init {
        clear()
    }
    ...
    override fun getDependencies(path: TreePath): List<String> {
        ...
        val objects: Array<Any> = last.getUserObjectPath()
    ...
    override fun addCombinationNode(
        ...
        val subDependency: String? = dependency.getSubDependencyElement(codeIndex)
    ...
    companion object {
         ...
         *
         */
        private const val serialVersionUID = 6787648525816814570L
    }
}