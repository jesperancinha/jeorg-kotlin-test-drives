...
dependencies {
    ...
    implementation("org.jetbrains.kotlin-wrappers:kotlin-react-router-dom:6.23.1-pre.773")
    implementation("org.jetbrains.kotlin-wrappers:kotlin-redux:4.1.2-pre.773")
    implementation("org.jetbrains.kotlin-wrappers:kotlin-react-redux:7.2.6-pre.773")
}
