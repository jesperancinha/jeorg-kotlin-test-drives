...
dependencies {
    ...
    implementation("org.jetbrains.kotlin-wrappers:kotlin-react-router-dom:6.17.0-pre.641")
    implementation("org.jetbrains.kotlin-wrappers:kotlin-redux:4.1.2-pre.643")
