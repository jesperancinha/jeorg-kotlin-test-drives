...
dependencies {
    ...
    implementation("org.jetbrains.kotlin-wrappers:kotlin-react:18.3.1-pre.844")
    implementation("org.jetbrains.kotlin-wrappers:kotlin-react-dom:18.3.1-pre.844")
    implementation("org.jetbrains.kotlin-wrappers:kotlin-emotion:11.13.5-pre.844")
