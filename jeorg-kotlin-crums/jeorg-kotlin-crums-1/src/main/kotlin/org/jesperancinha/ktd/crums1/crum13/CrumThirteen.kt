    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            ConsolerizerComposer.outSpace()
                .cyan(ConsolerizerComposer.title("Crum 13 - Kotlin precondition functions"))
                .magenta("In kotlin there are 5 main precondition functions")
                .none().orange("checkNotNull", "require", "requireNotNull", "error", "assert")
                .reset()
            ...
            try {
                ...
                ConsolerizerComposer.outSpace()
                    .magenta("if we signal our own error, we are affecting the state of the application")
                    .yellow(e)
            }
