...
public class RunSpellingCheck {
	 ...
	 * @return
	 */
	public static Set<RegionImpl> findSimilarRegions(Collection<? extends RegionImpl> regionA,
			Collection<? extends RegionImpl> regionB) {

		final List<RegionImpl> regionListA = new ArrayList<>(regionA);
		final List<RegionImpl> regionListB = new ArrayList<>(regionB);

		final Comparator<RegionImpl> comparator = new RegionComparator();
		...
		return new HashSet<>(regionListA);
	}
}
