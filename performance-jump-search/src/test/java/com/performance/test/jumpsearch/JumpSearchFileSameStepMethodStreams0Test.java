...
public class JumpSearchFileSameStepMethodStreams0Test {
	...
	public void testGetNumberIndexFromArray() throws Exception {
		...
		final int result = new JumpSearchFileSameStepMethodStreams0().getNumberIndexFromArray(20, testInputStream);
	...
	public void testGetNumberIndexFromArray_limit() throws Exception {
		final String testString = "1, 2, 8, 10, 20, 23, 27, 50, 90";
		final InputStream testInputStream = new ByteArrayInputStream(testString.getBytes(Charset.defaultCharset()));
		final int result = new JumpSearchFileSameStepMethodStreams0().getNumberIndexFromArray(90, testInputStream);
	...
	public void testGetNumberIndexFromArray_begining() throws Exception {
		final String testString = "1, 2, 8, 10, 20, 23, 27, 50, 90";
		final InputStream testInputStream = new ByteArrayInputStream(testString.getBytes(Charset.defaultCharset()));
		final int result = new JumpSearchFileSameStepMethodStreams0().getNumberIndexFromArray(1, testInputStream);
